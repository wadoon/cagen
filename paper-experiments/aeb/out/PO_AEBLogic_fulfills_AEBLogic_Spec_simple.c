...
bool post_contract_trans_sTANDBY_sTANDBY_0 = AEBstatus == 0 && decel == 0 && FCWactivate == 0;
bool contract_trans_sTANDBY_sTANDBY_0 = pre_contract_trans_sTANDBY_sTANDBY_0 && post_contract_trans_sTANDBY_sTANDBY_0;
bool pre_contract_trans_sTANDBY_WARN_1 = abs(TTC) < FCWtime && TTC >= 0;
bool post_contract_trans_sTANDBY_WARN_1 = AEBstatus == 0 && decel == 0 && FCWactivate == 1;
bool contract_trans_sTANDBY_WARN_1 = pre_contract_trans_sTANDBY_WARN_1 && post_contract_trans_sTANDBY_WARN_1;
bool pre_contract_trans_WARN_sTANDBY_2 = abs(TTC) >= (2 * FCWtime);
bool post_contract_trans_WARN_sTANDBY_2 = AEBstatus == 0 && decel == 0 && FCWactivate == 0;
bool contract_trans_WARN_sTANDBY_2 = pre_contract_trans_WARN_sTANDBY_2 && post_contract_trans_WARN_sTANDBY_2;
bool pre_contract_trans_WARN_BREAK_3 = abs(TTC) < PB1time && TTC >= 0;
bool post_contract_trans_WARN_BREAK_3 = AEBstatus > 0 && decel > 0 && FCWactivate == 1;
bool contract_trans_WARN_BREAK_3 = pre_contract_trans_WARN_BREAK_3 && post_contract_trans_WARN_BREAK_3;
bool pre_contract_trans_WARN_WARN_4 = !(abs(TTC) < PB1time && TTC >= 0);
bool post_contract_trans_WARN_WARN_4 = AEBstatus == 0 && decel == 0 && FCWactivate == 1;
bool contract_trans_WARN_WARN_4 = pre_contract_trans_WARN_WARN_4 && post_contract_trans_WARN_WARN_4;
bool pre_contract_trans_BREAK_BREAK_5 = !stop && TTC>=0;
bool post_contract_trans_BREAK_BREAK_5 = AEBstatus > 0 && decel > 0 && FCWactivate == 1;
bool contract_trans_BREAK_BREAK_5 = pre_contract_trans_BREAK_BREAK_5 && post_contract_trans_BREAK_BREAK_5;
bool pre_contract_trans_BREAK_sTANDBY_6 = stop  && TTC<0;
bool post_contract_trans_BREAK_sTANDBY_6 = AEBstatus == 0 && decel == 0 && FCWactivate == 1;
bool contract_trans_BREAK_sTANDBY_6 = pre_contract_trans_BREAK_sTANDBY_6 && post_contract_trans_BREAK_sTANDBY_6;
...
bool VALID_PRE_COND = (sTANDBY && pre_contract_trans_sTANDBY_sTANDBY_0) || (sTANDBY && pre_contract_trans_sTANDBY_WARN_1) || (WARN && pre_contract_trans_WARN_sTANDBY_2) || (WARN && pre_contract_trans_WARN_BREAK_3) || (WARN && pre_contract_trans_WARN_WARN_4) || (BREAK && pre_contract_trans_BREAK_BREAK_5) || (BREAK && pre_contract_trans_BREAK_sTANDBY_6);
bool VALID_POST_COND = (sTANDBY && t_26) || (sTANDBY && t_27) || (WARN && t_28) || (WARN && t_29) || (WARN && t_30) || (BREAK && t_31) || (BREAK && t_32);
