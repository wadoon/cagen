...
void next_TTC_Spec() {
  bool pre_contract_trans_s1_s1_7 = 0 <= mioDistance && mioDistance <= 1024 &&
                                    -1024 <= mioVelocity && mioVelocity <= 1024;
  bool post_contract_trans_s1_s1_7 =
      (collision == ((mioDistance - headawayOffset) < 2));
  bool contract_trans_s1_s1_7 =
      pre_contract_trans_s1_s1_7 && post_contract_trans_s1_s1_7;
